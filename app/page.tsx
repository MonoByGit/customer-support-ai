...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#07090E] text-slate-900 dark:text-slate-100 selection:bg-[#2196F3] selection:text-white overflow-x-hidden transition-colors duration-200">
      ...
      {/* Header */}
      <header className="border-b border-slate-200/80 dark:border-white/[0.07] bg-white/90 dark:bg-[#0C0F17]/90 backdrop-blur-xl sticky top-0 z-40 px-6 sm:px-10 py-3.5 transition-colors">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <span className="hidden sm:inline-block ml-2 text-[10px] bg-[#2196F3]/10 text-[#2196F3] font-semibold px-2 py-0.5 rounded-md border border-[#2196F3]/20 uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="grid grid-cols-3 gap-3 pt-6 border-t border-slate-200 dark:border-white/[0.08] max-w-lg">
              ...
              <div>
                <div className="text-xl sm:text-2xl font-bold text-[#FF9100] font-mono">
                  0%
                </div>
      ...
      {/* 4-Step Process */}
      <section className="px-6 sm:px-10 py-20 max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="pro-card p-6 space-y-3">
            ...
            <h3 className="font-bold text-base text-slate-900 dark:text-white">2-Way Synchronisatie</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
      ...
      {/* Industry Tabs */}
      <section className="py-16 border-t border-slate-200/80 dark:border-white/[0.07] bg-white/40 dark:bg-[#0A0D14]/40">
        <IndustryTabs />
      </section>

      {/* ROI Calculator */}
      <section className="px-6 sm:px-10 py-20 max-w-6xl mx-auto border-t border-slate-200/80 dark:border-white/[0.07]">
        <RoiCalculator />
      </section>

      {/* Pricing */}
      <section className="py-20 border-t border-slate-200/80 dark:border-white/[0.07] bg-white/40 dark:bg-[#0A0D14]/40">
        <PricingSection />
      </section>
      ...
      <section className="px-6 sm:px-10 py-20 max-w-5xl mx-auto text-center">
        <div className="bg-gradient-to-br from-[#0D47A1] to-[#0A192F] border border-[#2196F3]/30 text-white rounded-2xl p-8 sm:p-12 space-y-6 shadow-xl relative overflow-hidden">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200/80 dark:border-white/[0.07] bg-white dark:bg-[#0C0F17] py-8 px-6 text-center text-xs text-slate-500 dark:text-slate-400 space-y-2 transition-colors">
