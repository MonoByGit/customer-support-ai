...
export default function ClientPortalPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#090D11] text-slate-900 dark:text-[#F1F5F9] flex flex-col justify-between selection:bg-[#00D492] selection:text-black transition-colors">
      ...
      <header className="border-b border-black/[0.06] dark:border-white/[0.08] bg-white/80 dark:bg-[#161618]/80 backdrop-blur-2xl px-6 py-3.5 sticky top-0 z-30 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white bg-slate-100 dark:bg-white/[0.05] border border-slate-200 dark:border-white/[0.08] px-3.5 py-1.5 rounded-lg transition-all flex items-center gap-1.5"
          >
      ...
      {/* Main Content */}
      <main className="max-w-5xl w-full mx-auto px-6 sm:px-10 py-10 flex-1 space-y-8">
        
        {/* Welcome Banner */}
        <div className="pro-card p-6 sm:p-8 relative overflow-hidden bg-gradient-to-br from-[#2196F3]/[0.04] to-transparent border border-[#2196F3]/20">
        ...
        <div className="space-y-6">
          ...
          <div className="pro-card p-6 sm:p-8 space-y-5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-[#2196F3] text-white font-bold text-xs flex items-center justify-center shadow-xs">
                  1
                </div>
                <div>
              ...
              {/* Platform Switcher */}
              <div className="hidden sm:flex bg-slate-100 dark:bg-white/[0.04] p-1 rounded-lg border border-slate-200 dark:border-white/10 text-xs">
            ...
            <div className="relative">
              <div className="p-4 bg-slate-900 text-[#2196F3] rounded-xl font-mono text-xs overflow-x-auto border border-slate-800 flex items-center justify-between">
                <code>{widgetScriptCode}</code>
                <button
                  onClick={() => handleCopy(widgetScriptCode, "widget")}
                  className="bg-[#2196F3] hover:bg-[#1E88E5] text-white font-semibold px-3 py-1.5 rounded-lg text-xs flex items-center gap-1.5 transition-all shrink-0 ml-4 shadow-xs"
                >
            ...
            <div className="bg-slate-50 dark:bg-white/[0.03] p-4 rounded-xl border border-slate-200/80 dark:border-white/[0.06] text-xs text-slate-600 dark:text-slate-400 space-y-1">
          ...
          <div className="pro-card p-6 sm:p-8 space-y-5">
            ...
            <div className="bg-blue-50/60 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-500/20 rounded-xl p-4 space-y-3 text-xs">
                ...
                <li>
                  ...
                  <div className="inline-flex items-center gap-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 px-2 py-0.5 rounded font-mono text-[11px] ml-1 mt-1 text-slate-900 dark:text-white">
                    ...
                    <button
                      ...
                      className="text-[#2196F3] hover:underline text-[10px]"
                    >
          ...
          <div className="pro-card p-6 sm:p-8 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 bg-slate-50 dark:bg-white/[0.03] rounded-xl border border-slate-200/80 dark:border-white/[0.06] space-y-2 text-xs">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    readOnly
                    value={waDirectUrl}
                    className="flex-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-lg p-2 font-mono text-[11px]"
                  />
                  <button
                    onClick={() => handleCopy(waDirectUrl, "wa-url")}
                    className="bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 px-3 py-2 rounded-lg font-bold"
                  >
                    {copiedSection === "wa-url" ? <Check className="w-3.5 h-3.5 text-[#2196F3]" /> : <Copy className="w-3.5 h-3.5" />}
                  </button>
                </div>
              </div>
