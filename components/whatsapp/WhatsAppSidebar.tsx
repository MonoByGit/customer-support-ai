...
export const WhatsAppSidebar: React.FC<WhatsAppSidebarProps> = ({
  ...
  return (
    <div className="w-80 md:w-88 h-full bg-[#FFFFFF] border-r border-[#E9EDEF] flex flex-col shrink-0 select-none">
      {/* Sidebar Top Header */}
      ...
      {/* Search & Filter Bar */}
      <div className="p-2.5 border-b border-[#E9EDEF] space-y-2">
        <div className="bg-[#F0F2F5] rounded-lg px-3 py-1.5 flex items-center gap-2">
          ...
          <input
            ...
            className="bg-transparent text-xs text-[#111B21] placeholder:text-[#8696A0] w-full outline-none"
          />
        </div>
