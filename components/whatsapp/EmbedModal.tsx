...
<a
  ...
  style="display: inline-flex; align-items: center; gap: 8px; background-color: #2196F3; color: #ffffff; padding: 12px 20px; border-radius: 9999px; text-decoration: none; font-weight: 600; font-family: sans-serif;"
>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden border border-gray-100 animate-scale-up text-[#111B21]">
        ...
        <div className="p-5 space-y-4 max-h-[75vh] overflow-y-auto text-xs">
          ...
          <div className="space-y-1.5 bg-blue-50/70 p-3.5 rounded-xl border border-blue-200/80">
            <div className="flex items-center justify-between font-semibold text-[#0D47A1]">
              ...
              <button
                ...
                className="text-[#2196F3] hover:text-[#0D47A1] font-bold flex items-center gap-1"
              >
            ...
            <div className="bg-white p-2 rounded-lg border border-blue-200 font-mono text-[11px] break-all select-all text-gray-700">
              {waMeLink}
            </div>
          </div>
        ...
        <div className="bg-gray-50 px-5 py-3 border-t border-gray-100 flex justify-end">
          <button
            onClick={onClose}
            className="bg-[#0D47A1] hover:bg-[#0A387E] text-white px-4 py-2 rounded-xl text-xs font-semibold transition-colors"
          >
            Sluiten
          </button>
        </div>
